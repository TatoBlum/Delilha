...
// nombre apellido email telefono direccion password permisosId fechaDeCreacion fechaDeModificacion

module.exports.validarCamposNuevoUsuario = async function (data) {
    const { nombre, apellido, email, telefono, direccion, password, permisosId, fechaDeCreacion, fechaDeModificacion } = data;
    let errores = [];
